/*
 * This is a test case:
 * One process is mapping to one backing store and doesn't unmap the backing store explicitly.
 * OS is expected to unmap the process and bs when the process terminates.
 * */
#include <conf.h>
#include <kernel.h>
#include <proc.h>
